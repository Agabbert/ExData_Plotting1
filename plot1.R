## plot1.R for Week 1 Exploratory Analysis

### This script reads data household_power_consumption.txt file and creates a
### histogram of Global Active Power for the time period from 2007-02-01 to 
### 2007-02-02
...
hist(hhpc$Global_active_power, col = "red", xlab = "Global Active Power (kilowatts)",
